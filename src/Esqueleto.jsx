...
import { faHome, faHands, faHandsHelping, faUser,faTrophy, faCertificate, faArrowLeft } from '@fortawesome/free-solid-svg-icons';
            ...
            <body id="page-top">
                ...
                <div id="wrapper">
                    ...
                    <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                        ...
                        <li className="nav-item">
                            <Link className="nav-link collapsed" to="/experiences" data-toggle="collapse" data-target="#collapseTwo"
                                aria-expanded="true" aria-controls="collapseTwo">
